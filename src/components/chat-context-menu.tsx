...
export const ChatContextMenu = memo(function ChatContextMenu({ onShare, onRename, onMoveToProject, onRemoveFromProject, onDelete, onArchive, removeLabel }: ChatContextMenuProps) {
