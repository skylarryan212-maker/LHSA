...
export function ProjectCard({ project, onUpdate }: ProjectCardProps) {
  ...
  return (
    <ParallaxCard className="group relative rounded-xl border border-border bg-card/80 p-5 shadow-sm transition-[box-shadow,border-color,transform] hover:border-ring/50 hover:shadow-lg hover:shadow-black/30">
