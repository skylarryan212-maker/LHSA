    ...
    <div className="space-y-5">
      <section className="space-y-3">
        <div className="flex items-center justify-between py-2">
          <label className="text-sm font-normal text-foreground">Base style and tone</label>
      ...
      <section className="space-y-3 pt-3 border-t border-border">
        <h3 className="text-sm font-medium text-muted-foreground">Custom instructions</h3>
        <Textarea
      ...
      <section className="space-y-3 pt-3 border-t border-border">
        <div className="flex items-center justify-between">
          <h3 className="text-base font-medium text-foreground">Memory</h3>
          <Button variant="outline" size="sm" className="h-8" onClick={() => setOpenManage(true)}>Manage</Button>
        </div>
        <div className="space-y-0">
          <div className="flex items-start justify-between gap-4 py-3">
            <div className="flex-1">
              <label htmlFor="referenceSavedMemories" className="text-sm font-normal leading-none cursor-pointer">
          ...
          <div className="flex items-start justify-between gap-4 py-3 border-t border-border/50">
            <div className="flex-1">
              <label htmlFor="referenceChatHistory" className="text-sm font-normal leading-none cursor-pointer">
          ...
          <div className="flex items-start justify-between gap-4 py-3 border-t border-border/50">
            <div className="flex-1">
              <label htmlFor="allowSavingMemory" className="text-sm font-normal leading-none cursor-pointer">
                Allow saving memory
              </label>
