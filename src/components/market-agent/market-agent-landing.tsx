...
import { BackToAgentsLink } from "@/components/back-to-agents-link";
...
export function MarketAgentLanding({ initialInstances, initialEvents }: LandingProps) {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#060606] via-[#050507] to-black text-foreground">
      <BackToAgentsLink />
