...
export const MODEL_PRICING = {
  ...
  // OpenRouter via Chutes - OpenAI-compatible gpt-oss-20b (Chutes pricing - current)
  "openai/gpt-oss-20b": {
    input: 0.02,
    cached: 0,
    output: 0.10,
  },
  // OpenRouter via Hyperbolic - OpenAI-compatible gpt-oss-20b (Hyperbolic pricing - alternative)
  "openai/gpt-oss-20b-hyperbolic": {
    input: 0.04,
    cached: 0,
    output: 0.04,
  },
  // DeepInfra OpenAI-compatible gpt-oss-120b
  "openai/gpt-oss-120b": {
    input: 0.039,
    cached: 0,
    output: 0.19,
